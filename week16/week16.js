...
function makeOne() {
	// const amountOfForms = document.forms.length;
...
function makeTwo() {
	...
	// const nameOfFirst = firstForm.getAttribute('name');
...
function makeThree() {
	...
	// const nameOfLast = lastForm.getAttribute('name');
	// console.log(nameOfLast);
}
...
function makeFour() {
	...
	// 	}
	// }
	// let changeToString = formNames.join(' , ');
	// document.getElementById('practicum4').textContent = changeToString;
...
function makeFive() {
	...
	// thirdForm.elements.formThree;
	// const amountOfElements = thirdForm.elements.length;
...
function makeSeven() {
	// const allForms = document.forms;
	// const secondForm = document.forms[1];
	// document.forms.formTwo.elements;
	// let elementsList = [];
	// for(i = 0;i < secondForm.length; i++){
	// 	let second = secondForm[i];
	// 	let secondName = second.getAttribute('name');
	// 	if (secondName){
	// 		elementsList.push(`- ${secondName}`);
	// 	}
	// }
	// document.getElementById('practicum7').textContent = elementsList;
}
...
function makeEight() {
	// const firstForm = document.forms[0];
	// document.forms.formOne.elements;
	// let elementsList = [];
	// for(i = 0; i< firstForm.length;i++){
	// 	let first = firstForm[i];
	// 	let firstName = first.getAttribute('name');
	// 	if(firstName){
	// 		elementsList.push(firstName);
	// 	}
	// }
	// document.getElementById('practicum8').textContent = elementsList;
}
...
function makeNine() {
	// const thirdForm = document.forms[2];
	// document.forms.formThree.elements;
	// let elementsList = [];
	// for(i = 0; i< thirdForm.length;i++){
	// 	let third = thirdForm[i];
	// 	let thirdName = third.getAttribute('name');
	// 	if(thirdName){
	// 		elementsList.push(thirdName);
	// 	}
	// }
	// document.getElementById('practicum9').textContent = elementsList;
}
...
//Подсказка: используйте коллекцию document.forms для доступа к формам, свойство elements для доступа к элементам формы и свойство 
// value для получения значения radio кнопки

const paragraphTen = document.getElementById('practicum10');
// function makeTen(evt) {
// 	evt.preventDefault();
// 	const lastForm = document.forms[3];
// 	const radio = lastForm.elements.checkbox;
...
// 	const elements = formOne.elements.select;
// 	let elementsList = '';
// 	for(i = 0; i< elements.length;i++){
// 		elementsList += elements.value + ', ';
// 	}
